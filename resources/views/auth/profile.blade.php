            ...
            <div class="middle">
                ...
                <div class="perfil">
                    <div class="row justify-content-start">
                        ...
                        <div class="col-3 btn-action">
                            <x-button class="botao">
                            <a href="/edit-profile">Editar
                            </a>
                            </x-button>
                        </div>
                    </div>
                    ...
                    <div class="count row justify-content-center">
                            <div class="count col-3">
                                <h6>{{count(Auth::user()->post)}} Post</h6>
                            </div>
                            <div class="count col-3">
                                <h6>{{ count(Auth::user()->followers) }} Seguidores</h6>
                            </div>
                            <div class="count col-3 mb-3">
                                <h6>{{ count(Auth::user()->following)}} Seguindo</h6>
                            </div>
                    </div>

                    <div class="row justify-content-center">
                            <div class="col-9">
                                <h6>Pronome {{Auth::user()->pronoun}}</h6>
                            </div>
                            <div class="col-9">
                                <h6>Bio {{Auth::user()->bio}}</h6>
                            </div>
                            <div class="col-9">
                                <h6>Aniversário {{Auth::user()->date}}</h6>
                            </div>
                    </div>
                </div>
                            ...
                            <!-- ====== SOLICITAÇÃO 1 ====== -->
                                @if ($friends->isEmpty())
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <td colspan="3" class="text-center">Você ainda não segue ninguém.<br> Os usuários que você seguir aparecerão aqui </td>
                                    </th> 
                                @else
