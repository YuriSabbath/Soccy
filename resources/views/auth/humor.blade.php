        ...
        <div class="container">
            ...
            <div class="left">
                ...
                <div class="sidebar">
                    ...
                    <a class="menu-item active" href="/humor">
                ...
                <!---------- END OF SIDEBAR ---------->
                    <button type="button" class="botao" data-bs-toggle="modal" data-bs-target="#humorModal">
                        Qual seu humor?
                    </button> 
            </div>
            ...
            <div class="modal fade" id="humorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-field">
                            <input type="text" name="humor" id="nomeDoTopico" placeholder="Hoje estou..." required>
                    ...
                    <ol class="list-group list-group-numbered">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div><h5>{{$humor->humor}}</h5></div>
                            </div>
                            <div>{{$humor->updated_at}}</div>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <x-button class="mt-4" class="botao" type="button" data-bs-toggle="modal" data-bs-target="#excluir-humorModal">
                                    Excluir
                                </x-button>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="excluir-humorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        Deseja realmente excluir esse humor? Essa ação não pode ser desfeita.
                    </div>
                    <div class="modal-footer">
